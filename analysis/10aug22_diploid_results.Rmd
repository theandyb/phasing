...
whatshap_dir2 <- "/net/snowwhite/home/beckandy/research/phasing/output/27sept/whatshap/"
...
sum(switch_err_shapeit$start_flip) - 69 - 78 - 52
sum(switch_err_eagle$start_flip) - 69 - 78 - 38
sum(switch_err_beagle$start_flip) - 69 - 52 - 38
...
df_vcftools %>%
  ...
  geom_density() +
  geom_vline(xintercept = qchisq(0.05, df = 1, lower.tail = F)) +
  ggtitle("Chi-Square Test: SHAPEIT4", "Proportion of Errors at CpGs = Proportion 1KGP Variants at CpG") +
  xlab("Density") +
  ylab("Chi Square Statistics")
...
df_vcftools %>%
  ...
  geom_density() +
  geom_vline(xintercept = qchisq(0.05, df = 1, lower.tail = F)) +
  ggtitle("Chi-Square Test: SHAPEIT4", "Proportion of Flips at CpGs = Proportion 1KGP Variants at CpG") +
  xlab("Density") +
  ylab("Chi Square Statistics")
```
...
get_dens_for_pd(sample(101:300, 1))
get_dens_for_pd(sample(1:100, 1))
