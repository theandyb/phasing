...
VCF="/net/snowwhite/home/beckandy/research/phasing/data/ref/chrX_nonPAR_mask_noSing.bcf"
...
# Filter VCF to our subjects and their list of sites, removing sites with no alt as well
