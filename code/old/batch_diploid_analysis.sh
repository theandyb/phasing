...
#SBATCH --array=1-300
#SBATCH -e /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/slurm/pair.%A_%a.err
#SBATCH --output=/net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/slurm/pair.%A.%a.out
...
echo -e "${SLURM_ARRAY_TASK_ID}\t$n_sites" > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/vcf_n_sites/pair_${SLURM_ARRAY_TASK_ID}_all.txt
...
echo -e "${SLURM_ARRAY_TASK_ID}\t$n_hets" > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/vcf_n_sites/pair_${SLURM_ARRAY_TASK_ID}_hets.txt
...
echo -e "${SLURM_ARRAY_TASK_ID}\t$n_ref" > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/vcf_n_sites/pair_${SLURM_ARRAY_TASK_ID}_ref.txt
...
bcftools view /tmp/andy_ref_${SLURM_ARRAY_TASK_ID}.bcf -Oz > /tmp/andy_ref_${SLURM_ARRAY_TASK_ID}.vcf.gz
...
vcftools --vcf /tmp/andy_eagle_${SLURM_ARRAY_TASK_ID}.vcf \
  ...
  --diff-switch-error \
  --out /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/eagle/error_${SLURM_ARRAY_TASK_ID}

vcftools --gzvcf /tmp/andy_shapeit_${SLURM_ARRAY_TASK_ID}.vcf.gz \
  --gzdiff /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_truth.vcf.gz \
  --diff-switch-error \
  --out /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/shapeit/error_${SLURM_ARRAY_TASK_ID}

vcftools --gzvcf /tmp/andy_beagle_${SLURM_ARRAY_TASK_ID}.vcf.gz \
  --gzdiff /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_truth.vcf.gz \
  --diff-switch-error \
  --out /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/beagle/error_${SLURM_ARRAY_TASK_ID}
...
## bedtools intersect
tail -n+2 /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/eagle/error_${SLURM_ARRAY_TASK_ID}.diff.switch |\
  bedtools intersect -a - -b /tmp/andy_sites_${SLURM_ARRAY_TASK_ID}.bed -c > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/eagle/hets_per_region_${SLURM_ARRAY_TASK_ID}.bed

tail -n+2 /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/shapeit/error_${SLURM_ARRAY_TASK_ID}.diff.switch |\
  bedtools intersect -a - -b /tmp/andy_sites_${SLURM_ARRAY_TASK_ID}.bed -c > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/shapeit/hets_per_region_${SLURM_ARRAY_TASK_ID}.bed


tail -n+2 /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/beagle/error_${SLURM_ARRAY_TASK_ID}.diff.switch |\
  bedtools intersect -a - -b /tmp/andy_sites_${SLURM_ARRAY_TASK_ID}.bed -c > /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/switch_errors/shapeit/hets_per_region_${SLURM_ARRAY_TASK_ID}.bed
...
whatshap compare --names truth,eagle --tsv-pairwise /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/whatshap/eagle/eval_${SLURM_ARRAY_TASK_ID}.tsv /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_truth.vcf /tmp/andy_eagle_${SLURM_ARRAY_TASK_ID}.vcf
# need gunzipped shapeit
gunzip /tmp/andy_shapeit_${SLURM_ARRAY_TASK_ID}.vcf.gz
whatshap compare --names truth,shapeit --tsv-pairwise /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/whatshap/shapeit/eval_${SLURM_ARRAY_TASK_ID}.tsv /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_truth.vcf  /tmp/andy_shapeit_${SLURM_ARRAY_TASK_ID}.vcf
...
mv /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_test.bcf /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/vcf/test/
rm /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_test.vcf.gz
mv /tmp/andy_input_${SLURM_ARRAY_TASK_ID}_truth.vcf /net/snowwhite/home/beckandy/research/phasing/output/19april22_switch_errors/vcf/truth/
