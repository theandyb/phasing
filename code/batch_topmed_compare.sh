...
what_dir="/net/snowwhite/home/beckandy/research/phasing/output/filter_switch_errors/whatshap/topmed"
vt_dir="/net/snowwhite/home/beckandy/research/phasing/output/filter_switch_errors/switch_errors/topmed"

bcftools view -Ov ${in_dir}/pair_${SLURM_ARRAY_TASK_ID}_true.bcf > /tmp/andy_true_${SLURM_ARRAY_TASK_ID}
bcftools view -s "FAKE${SLURM_ARRAY_TASK_ID}" -Ov ${in_dir}/topmed_res/topmed.bcf > /tmp/andy_topmed_${SLURM_ARRAY_TASK_ID}
